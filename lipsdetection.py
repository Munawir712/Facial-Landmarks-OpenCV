...
prediction = dlib.shape_predictor("landmarks/shape_predictor_68_face_landmarks.dat")
...
while True:
    ...
    for face in faces:
        ...
        landmarks = prediction(imgGray,face)
        myPoints = []
        for n in range(68):
            ...
            # cv2.putText(imgOriginal,str(n),(x,y-10),cv2.FONT_HERSHEY_COMPLEX_SMALL,0.8,(255,0,0),1)
